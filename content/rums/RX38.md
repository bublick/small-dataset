...
ai:
    cons:
        ...
        - Intense glue notes
    description:
        Indulge in the exquisite 39th Release (The Last) Heavy Trinidad Rum,
    ...
    review_data:
        ...
        ratingCount: 151
        review:
            A bold Caroni treasure with a symphony of woody, rubbery, and spicy notes.
...
description:
    Experience the 23-year aged Caroni 39th Release, a 9.4-rated Trinidad
...
url: /rums/38/velier-caroni-39th-release-the-last-heavy-trinidad-rum
...
reviews:
    ...
    - comment: 'The Epic Velier Caroni Tasting 2023:
      ...
      username: Jakob
    - comment:
          What a Caroni ! Round, yet complex, little dirty, just perfect! Benchmark
    ...
    - comment: "wow \U0001F60D\ndefinitely one of my favorite caronis!"
      ...
      username: Mirco
    - comment:
          My absolute benchmark what (for me) Caroni concerns. There just fits everything
      ...
      username: 'SaibotZtar '
    - comment:
          Great Caroni with all the flavors you would expect from a Caroni. The dirty
    ...
    - comment:
          "A true masterpiece. Alcohol integration is perfect. Typical 1996 profile\
      ...
      username: Maxence
    - comment:
          Still absolute top notch out of 96. Leaning a bit more towards the dirty
    ...
    - comment:
          'In a word: COMPLETENot only as Caroni, but also as rum in general. Rarely
    ...
    - comment:
          "Nez : Caroni bien comme on aime. Des notes plus profondes/m\xFBres, c'est\
    ...
    - comment:
          No, nothing really needs to be written about this rum. Even if I had not
    ...
    - comment: "Well then, let's see what it can do...
      ...
      username: RumTaTa
    - comment:
          "Wow, a feeling of enlightenment, like my first Caroni. Sensational nose,\
      ...
      username: Serge
    - comment:
          "the full score is only denied him because Luca Gargano might yet pull\
      ...
      username: mto75
    - comment:
          "This is exactly how a Caroni must be for me! He has all facets with a\
    ...
    - comment:
          "Beim Last Caroni treten die typischen Werkstattger\xFCche eher in den\
    ...
    - comment:
          "Discover and enjoy. Extremely versatile and something quite great. Endless\
    ...
    - comment:
          'About this rum need not say much: a bomb in the glass and somehow also
          a legend.'
    ...
    - comment:
          the best caroni I've ever tasted, although it's not amazing. full body,
    ...
    - comment: Horny shit :) must have tried if you like Caroni
      ...
      username: Matthias
    - comment:
          Wow, bombastic nose, even though I absolutely cannot relate to this rum
    ...
    - comment:
          "Wow...today then finally tasted my sample...what would I give for a whole\
    ...
    - comment:
          My first Caroni and I was not disappointed! Thank you to Modern Alchemist
    ...
    - comment:
          Personally, the best Caroni I have drunk. Spicy, dirty and long finish.
      ...
      username: Bernardo
    - comment:
          'This is just so enjoyable. At first I smell a burnt salty caramel, then
    ...
    - comment:
          'Un excellent Caroni avec tous les marqueurs de la distillerie. La puissance
