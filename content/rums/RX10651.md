...
ai:
    ...
    description:
        "Discover the enchanting world of Hampden's Great House (Distillery\
    ...
    review_data:
        ...
        ratingCount: 220
        review:
            A complex, fruity Jamaican delight with hints of grilled pineapple and
...
charts: []
description:
    Discover Hampden's Great House Rum, a 7-yr limited edition with tropical
...
url: /rums/10651/hampden-great-house-distillery-edition-2021
...
reviews:
    ...
    - comment:
          'This one is close to the other two, but I would have loved a higher ABV.
    ...
    - comment:
          "This is a really nice Hampden release. Very round and tasty with lots\
      ...
      username: Dom M
    - comment:
          "Compared to the 2020 version, less powerfull and woodier in the finish.\
      ...
      username: Galli33
    - comment:
          'Tasted as a 5cl sample.Olfactory initially a lot of natural yogurt / butter,
    ...
    - comment: Very nice nose but mouth well below the 2020
      ...
      username: Forrest
    - comment:
          On the nose beautiful fruity aromas of tropical fruits, mango, papaya,
      ...
      username: tojo
    - comment:
          'Specifics from my comparative tasting with HD GH ''19, ''20 and ''21:Nose:
      ...
      username: RumTaTa
    - comment:
          'Tasting day 1: Ananas! Nice nose and taste. There is a strong fruity sweetness,
      ...
      username: MarcT
    - comment:
          I prefer the 2020, find the 2020 more complex...but still very good drinking
          Hampden...like it
    ...
    - comment:
          Vitamin C fruits found in an alcoholic not quite pleasant spiciness, which
      ...
      username: Christoph
    - comment:
          "These Great House wines are definitely very good, and 2021 is no exception.
      ...
      username: Vincent D
    - comment:
          "This is tame but typical Hampden DNA: overripe pineapple and esters, rather
    ...
    - comment:
          Very good rum rich in aroma and taste, esters and tropical fruits (especially
          pineapple).
      ...
      username: Michal S
    - comment:
          'in direct comparison with the GH20. First impression on the nose: the
      ...
      username: mto75
    - comment:
          Significantly milder than the predecessors. Also due to the 55%. Pleasant
    ...
    - comment:
          "Third expression in the Hampden Great House series, this one has all the\
      ...
      username: Stylo
    - comment:
          The most balanced of the 3 releases so far. Great Hampden for relaxing
          evenings!
    ...
    - comment:
          A typical Hampden with character. The nose is very fruity, concentrated
      ...
      username: TheRhumhoe
    - comment:
          "What a treat for such a young Jam. Complex, with well-developed aromas.\
      ...
      username: alex
    - comment:
          "This could have been one of my daily goto rum if it where easier to get\
      ...
      username: Stefan L
    - comment:
          Comparison between 19, 20 and 21:Most ester and kick in comparison and
    ...
    - comment:
          For me, the Great House 2021 brings everything I want from a Hampden. Ester,
    ...
    - comment:
          "Tasted in parallel with the 2020 in joyful anticipation of the 2022 \U0001F602\
      ...
      username: Serge
    - comment:
          A very complex intense rum! The fruit esters predominate on the nose! The
    ...
    - comment:
          I finally got my hands on this bottle, which is already on sale at crazy
    ...
    - comment: "50% LFCA 2011
      ...
      username: Frank
    - comment:
          "Hampden proste parada, komplexni dlouhotrvaj\xEDc\xED chut a zaver suchy\
          \ a koreneny"
